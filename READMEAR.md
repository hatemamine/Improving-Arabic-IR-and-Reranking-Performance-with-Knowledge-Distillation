...
# تحسين نظم استرجاع المعلومات وترتيبها باستخدام طريقة التقطير المعرفي

 🙌 مرحبابكم يهدف هذا المشروع إلى تحسين نظم إسترجاع المعلومات الخاصة بالغة العربية بإستخدام نماذج الذكاء الإصطناعي
